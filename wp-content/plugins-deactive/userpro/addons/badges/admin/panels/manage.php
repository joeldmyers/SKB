	...
	<tr valign="top">
		...
		<td>
			<select name="badge_method" id="badge_method" class="chosen-select" style="width:300px" data-placeholder="">
				<option value="manual_roles" <?php if (userpro_badges_admin_edit()) echo 'disabled="disabled"'; ?>><?php _e('Give this badge to roles (manual)','userpro'); ?></option>
				...
				<option value="Defaultbadge"><?php _e('Default Badge for All','userpro'); ?></option>
			</select>
		</td>
	</tr>
