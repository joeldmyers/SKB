<?php
	...
	<?php 
			...
			if ( userpro_get_option('instagram_connect') == 1 && userpro_get_option('instagram_app_key') && userpro_get_option('instagram_Secret_Key') ) {
				...
				?><a href="#" id="wpInLoginBtn" class="userpro-social-instagram userpro-tip" data-redirect="<?php echo $array['facebook_redirect']; ?>" title="<?php _e('Login with Instagram','userpro'); ?>"></a>
