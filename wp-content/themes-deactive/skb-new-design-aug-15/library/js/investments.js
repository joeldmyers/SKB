jQuery(document).ready( function (){
	...
	jQuery('#read_investment').on('click', function(){
        ...
        //    console.log(Investment.ajaxurl);
		jQuery.post(
		    Investment.ajaxurl, {
                ...
                window.open(Investment.offering_pdf, '_blank');
               // var win = window.open(Investment.offering_pdf, '_blank');
               // win.focus();
        ...
        //jQuery('#invest_deal_dropdown').change(function(){
           // var form = jQuery(this).val();
          //  console.log(form);
          // jQuery('#invest-deal-'+form).text('test');
       // });
