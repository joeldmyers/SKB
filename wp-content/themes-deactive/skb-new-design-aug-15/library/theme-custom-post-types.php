...
function skb_post_types( $post_types ) {
	...
	$post_types['investment'] = array(
		'labels' => piklist('post_type_labels', 'Investments Offerings'),
        ...
        $post_types['investment_entity'] = array(
		'labels' => piklist('post_type_labels', 'Investment Entities'),
		'public' => false,
		'show_ui' => true,
		'menu_icon' => 'dashicons-admin-network',
		'rewrite' => array(
			'slug' => 'investment-entities'
			),
		'public' => true,
...
>>>>>>> master
	...
	$post_types['investor_message'] = array(
        ...
        $post_types['investor_docs'] = array(
		'labels' => piklist('post_type_labels', 'Investor Docs'),
		'public' => false,
		'show_ui' => true,
		'menu_icon' => 'dashicons-format-aside',
		'rewrite' => array(
			'slug' => 'investment-docs'
			),
		'supports' => array(
			),
		'hide_meta_box' => array(
