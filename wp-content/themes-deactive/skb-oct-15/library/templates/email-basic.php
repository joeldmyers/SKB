                                    ...
                                    <table border="0" cellpadding="0" cellspacing="0" width="100%" id="templateLogo">
                                        <tr>
                                            <td valign="top" class="headerContent">
                                            	<img src="<?php echo 'https://dev.skbincrowd.com/wp-content/uploads/images/logo.png'; ?>" style="max-width:320px; padding: 20px;" id="headerLogo" />
                                            </td>
                                        </tr>
                                    </table>
                            	</td>
                        	...
                        	<tr>
                            	<td align="center" valign="top">
                                    <table border="0" cellpadding="0" cellspacing="0" width="100%" id="templateHeader">
                                        <tr>
                                            <td valign="top" class="headerContent">
                                            	<img src="<?php echo home_url( '/wp-content/uploads/images/email_header.png' ); ?>" style="max-width:600px;" id="headerImage" />
                                            </td>
                                        </tr>
                                    </table>
                                </td>
