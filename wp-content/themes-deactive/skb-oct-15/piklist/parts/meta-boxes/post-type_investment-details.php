...
piklist( 'field', array (
                'type' => 'number',
                'scope' => 'post_meta',
                'field' => 'investment_available_equity',
                'label' => __( 'Available Equity' ),
                'description' => __( 'The total amount of equity available for the offering' ),	
                'attributes' => array(
...
piklist( 'field', array (
                'type' => 'number',
                'scope' => 'post_meta',
                'field' => 'investment_total_invested',
                'label' => __( 'Total Invested' ),
                'description' => __( 'The total of all approved investments' ),	
                'attributes' => array(
			'class' => 'readonly text form-control currency'
		),
));
...
piklist( 'field', array (
                'type' => 'number',
                'scope' => 'post_meta',
                'field' => 'investment_total_equity',
                'label' => __( 'Total Equity' ),
                'description' => __( 'The total amount of equity already invested (including Partner Equity)' ),	
                'attributes' => array(
			'class' => 'form-control currency'
		),
));
...
piklist( 'field', array (
                'type' => 'number',
                'scope' => 'post_meta',
                'field' => 'investment_remaining_equity',
                'label' => __( 'Remaining Equity' ),
                'description' => __( 'The amount of equity remaining available to investors' ),	
                'attributes' => array(
			'class' => 'form-control currency'
		),
));
...
piklist( 'field', array (
                'type' => 'number',
                'scope' => 'post_meta',
                'field' => 'investment_partner_equity',
                'label' => __( 'Partner Equity' ),
                'description' => __( 'The amount of equity invested (externally by SKB partners) and not available to website investors' ),	
                'attributes' => array(
			'class' => 'form-control currency'
		),
));
